...
namespace Foxy.Params.SourceGenerator.SourceGenerator
{
    internal class OverridesGenerator
    {
        ...
        public SourceText Execute()
        {
            ...
            _sourceBuilder.AppendSyntaxNode(CompilationUnit().WithMembers(List(FileContent())));

            IEnumerable<MemberDeclarationSyntax> FileContent()
            {
                var first = true;
                foreach (var item in GenerateNamespace())
                {
                    ...
                    if(first)
                    {
                        member = member.WithLeadingTrivia(AutoGeneratedComment(),
        ...
        private IEnumerable<MemberDeclarationSyntax> GenerateNamespace()
        {
            ...
            return GenerateNamespaceMembers();
