...
namespace Foxy.Params.SourceGenerator.SourceGenerator
{
    ...
    {
        private readonly SourceBuilder sb;
        private readonly INamedTypeSymbol typeInfo;
        private readonly IEnumerable<SuccessfulParamsCandidate> uniqueClass;
        public OverridesGenerator(INamedTypeSymbol typeInfo, IEnumerable<SuccessfulParamsCandidate> paramsCandidates)
        {
            ...
            this.uniqueClass = paramsCandidates ?? throw new ArgumentNullException(nameof(paramsCandidates));
        }
